    ...
    <div class="row">
      <div class="col-lg-4 profileColumn">
        <div class="profileSidebar">
          ...
          <div class="psPhoto">
            <img src="/images/nasrullah.jpg" alt="nasrullah" />
            <div class="psSocial">
              <a
                href="https://facebook.com/halo.nasrullah"
                target="_blank"
                class="fac"
                ><i class="icofont-facebook"></i
              ></a>
              <a
                href="https://twitter.com/nasrullahID"
                target="_blank"
                class="twi"
                ><i class="icofont-twitter"></i
              ></a>
              <a
                href="https://github.com/nasrullahid"
                target="_blank"
                class="git"
                ><i class="icofont-github"></i
              ></a>
              <a
                href="https://www.instagram.com/halo.nasrullah"
                target="_blank"
                class="ins"
          ...
          <div class="psFooter">
            <a href="javascript:void(0);" class="btt_btn only_icon btt_reverse"
              ><span><i class="icon icon-DownloadCloud"></i></span
            ></a>
            <a href="javascript:void(0);" class="btt_btn contact_me"
              ><span><i class="icon icon-Bag"></i> Hire Me</span></a
            >
          </div>
        </div>
      </div>
      <div class="col-lg-8 contentColumn" id="tabContainer">
        <header class="header clearfix">
          <a href="javascript:void(0)" class="menu_btn"
            ><i class="icofont-navigation-menu"></i>Menu</a
          >
          <nav class="mainMenu">
            <ul class="clearfix" id="mainTab">
              <li class="active">
                <a href="#home"
                  ><i class="icon icon-House"></i><span>Home</span></a
                >
              </li>
              <li>
                <a href="#resume"
                  ><i class="icon icon-User"></i><span>Resume</span></a
                >
              </li>
              <li>
                <a href="#portfolio"
                  ><i class="icon icon-Bulb"></i><span>Portfolio</span></a
                >
              </li>
              <li>
                <a href="#blog"
                  ><i class="icon icon-ClipboardText"></i><span>Blog</span></a
                >
              </li>
              <li>
                <a href="#contact"
                  ><i class="icon icon-Imbox"></i><span>Contact</span></a
                >
              </li>
            </ul>
          </nav>
          <a href="#" class="sidebarToggler"
              ...
              <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="icon_box_01">
                          ...
                          <p>
                            <a
                              href="https://goo.gl/maps/fEtrK4a542F89LpL8"
                              target="_blank"
                              >Click Here to View Map.</a
                            >
                          </p>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="abContent">
                      <p>
                        Nama lengkap saya Nasrullah, lahir di Sinjai 30 Desember
                        1992. Pendidikan SD-SMA saya masih di kota kelahiran.
                        Pada tahun 2011 saya kuliah di Universitas Negeri
                        Makassar Jurusan Pendidikan Teknik Elektro dan mengambil
                        Program Studi Pendidikan Teknik Informatika dan
                        Komputer.
                      </p>
                      <p>
                        Saya mulai fokus dalam dunia developer khusnya di web
                        developer pada tahun 2014 yang saya mulai dari tugas
                        akhir kuliah saya dengan judul penelitian "Early Warning
                        Sistem Keamanan Lingkungan Berbasi SMS Broadcast".
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row itemMb30">
                  <div class="col-lg-4">
                    <div class="icon_box_02">
                      ...
                      <h5>from scratch</h5>
                      <p>
                        Sunt explicabo. Nemo enim ipsam voluptatem quia sit
                        voluptas aspernatur.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="testimonialSlider owl-carousel">
                      <div class="singleTestimonial">
                        ...
                        <div class="testicon">
                          <p>
                            They'll have to make the best of things its an
                            uphill climb. Said Californ'y is the place you ought
                            to be So they loaded up the truck and moved to
                ...
                <div class="row mt30">
                  <div class="col-lg-12">
                    <div class="clientSlider owl-carousel">
                      ...
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/9.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/10.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/11.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/12.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/13.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/14.png" alt="Client" />
                        </a>
                      </div>
                      <div class="sliderItem">
                        <a href="javascript:void(0);">
                          <img src="/images/client/15.png" alt="Client" />
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row mb30">
                  <div class="col-lg-4">
                    <div
                      class="icon_box_03 text-center hasCounter"
                      data-count="10"
                    >
                      <div class="icon_div">
                ...
                <div class="row">
                  <div class="col-lg-12 text-center">
                    <div class="copyRight">
                      ...
                      <a href="https://nasrullah.id" target="_blank"
                        >nasrullah.id</a
                      >
                    </div>
                  </div>
                    ...
                    <div class="kr-accordion" id="edication_accordion">
                      <div class="card">
                        ...
                        >
                          <div class="card-body">
                            <div class="ac_meta">
                              <span>Passing Year: 2008</span
                              ><span>Grade: 3.92</span>
                            </div>
                      ...
                      <div class="card">
                        ...
                        >
                          <div class="card-body">
                            <div class="ac_meta">
                              <span>Passing Year: 2010</span
                              ><span>Grade: 3.85</span>
                            </div>
                            Anim pariatur cliche reprehenderit, enim eiusmod
                            high life accusamus terry richardson ad squid. 3
                            wolf moon officia aute, non cupidatat skateboard
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="filterUL">
                      ...
                      <li class="filter" data-filter="illustrtopm">
                        Illustration
                      </li>
                    </ul>
                  </div>
                ...
                <div class="row" id="Grid">
                    ...
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Artwork Design</a>
                        </h3>
                        <p class="folio_cat">
                  ...
                  <div class="col-lg-4 folio_effect mix dev">
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Web App</a>
                        </h3>
                        <p class="folio_cat">
                  ...
                  <div class="col-lg-4 folio_effect mix illustrtopm">
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Pencil Drawing</a>
                        </h3>
                        <p class="folio_cat">
                          <a href="portfolio.html">Illustration</a>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 folio_effect mix app">
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Graphic App</a>
                        </h3>
                        <p class="folio_cat">
                          <a href="portfolio.html">App</a>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 folio_effect mix graphic">
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Awesome Illustration</a>
                        </h3>
                        <p class="folio_cat">
                  ...
                  <div class="col-lg-4 folio_effect mix dev">
                    <div class="folio_item">
                      ...
                      <div class="folio_content">
                        <h3 class="folio_title">
                          <a href="single_folio.html">Frontend Development</a>
                        </h3>
                        <p class="folio_cat">
                          <a href="portfolio.html">Development</a>
                        </p>
                ...
                <div class="row loadMoreRow mb22">
                  <div class="col-lg-12 loadMoreCol text-center mt23">
                    <a
                      href="#"
                      data-count="1"
                      class="btt_btn bttb_dark loadMoreItem"
                      ><span
                        ><i class="icon icon-Restart"></i> Load More</span
                      ></a
                    >
                  </div>
                </div>
                  ...
                  <div class="col-lg-6">
                    <div class="blogItem text-left">
                      ...
                      <div class="biDetails">
                        <h3>
                          <a href="single_blog.html"
                            >10 Tell-Tale Signs You Need to Get New
                            Technology</a
                          >
                        </h3>
                        <p>
                          Morbi ullamcorper vel nunc quis venenatis. Ut auctor
                          dapibus dignissim. Sed tincidunt non odio id dignissim
                          donec.
                        </p>
                        <a href="single_blog.html" class="btt_link"
                  ...
                  <div class="col-lg-6">
                    <div class="blogItem text-left">
                      ...
                      <div class="biDetails">
                        <h3>
                          <a href="single_blog.html"
                            >A Technology Success Story You'll Never Believe</a
                          >
                        </h3>
                        <p>
                          Morbi ullamcorper vel nunc quis venenatis. Ut auctor
                  ...
                  <div class="col-lg-6">
                    <div class="blogItem text-left">
                      ...
                      <div class="biDetails">
                        <h3>
                          <a href="single_blog.html"
                            >The Worst Videos of All Time About Technology</a
                          >
                        </h3>
                        <p>
                          Morbi ullamcorper vel nunc quis venenatis. Ut auctor
                  ...
                  <div class="col-lg-6">
                    <div class="blogItem text-left">
                      ...
                      <div class="biDetails">
                        <h3>
                          <a href="single_blog.html"
                            >20 Resources That'll Make You Better at
                            Technology</a
                          >
                        </h3>
                        <p>
                ...
                <div class="row mb30">
                    ...
                    <div class="contact_form">
                      <form method="post" action="#" id="contactForm">
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <button type="submit" class="btt_btn">
                              <span
                                ><i class="icon icon-Mail"></i>Send
                                Message</span
                              >
                            </button>
                          </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="icon_box_01 addrBox">
                      ...
                      <h3>Address</h3>
                      <p>
                        Jl. Boulevard Ruko Cempaka, Makassar, Indonesia
                      </p>
                    </div>
                  </div>
                </div>
